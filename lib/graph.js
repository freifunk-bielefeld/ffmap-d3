...
function reload() {
  ...
  function handler(json) {
	...
	for(i in communities) {
		...
		var community_label = community_labels[community];
		if(!community_label) community_label = community;
		...
		meshstats.append("p").text(nNodes + " Knoten / " + nClients + " Clients / " + nGateways + " GWs");
	}
