...
function show_node(query) {
  ...
  vis.selectAll(".node")
    .classed("marked", function(d) {
      return (typeof(d.name) == 'string') && ((d.name.toLowerCase().indexOf(query.toLowerCase()) >= 0) ||
...
function reload() {
  ...
  function handler(json) {
    ...
    var communities = Object.keys(objs).map(function (key) { return objs[key]; });
    communities.sort(function(a,b) {return (a.nodecount < b.nodecount) ? 1 : ((b.nodecount < a.nodecount) ? -1 : 0);} );
