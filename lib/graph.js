...
var filterCommunities = { "bielefeld" : "Freifunk Bielefeld" };
  ...
  function handler(json) {
	...
	for(i in communities) {
		...
		if(filterCommunities.length) {
			community_label = filterCommunities[community];
		...
		meshstats.append("p").text(nNodes + " Knoten");
		if(nGateways) meshstats.append("p").text(nGateways + " Gateways");
		meshstats.append("p").text("ungefähr " + nClients + " Clients");
	}
	...
	if(nCommunities) meshstats.append("p").text(nCommunities + " Communities");
	meshstats.append("p").text(nNodes + " Knoten");
	meshstats.append("p").text(nGateways + " Gateways");
	meshstats.append("p").text("ungefähr " + nClients + " Clients");
